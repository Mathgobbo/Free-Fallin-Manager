...
class AppController:
  def __init__(self):
    ...
    self.__flightRegistrationController = FlightRegistrationController(self, self.__planeDao, self.__flyMemberDao)
    ...
    self.__clientSignUpToFlightController = ClientFlightsSignUpController(self,self.__flyMemberDao)
